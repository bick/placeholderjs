                    ...
                    <TabsContent value="cdn">
                        <div className="flex flex-col">
                            ...
                            <p className="text-xl mb-8 opacity-75">
                                ...
                                support HEX values or named values (e.g. white).
                            </p>
                            <Code type="command"
                                  code="https://placeholderjs.com/500x500?text=Hello+World!?color=#fff"/>
                            ...
                            <Code type="command" code="https://placeholderjs.com/500x500?background=#000"/>
                        </div>
                    </TabsContent>
